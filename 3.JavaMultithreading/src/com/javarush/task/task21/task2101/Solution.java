...
public class Solution {
    ...
    public static void print(byte[] bytes) {
        ...
        for (int i = 0; i < bytes.length; i++) {
            ...
            byteString[i] = String.format("%8s",Integer.toBinaryString(bytes[i] & 0xFF)).replace(" ","0");
        }
        System.out.println(byteString[0] +" " + byteString[1] + " " + byteString[2] + " " + byteString[3]);
    }
}
