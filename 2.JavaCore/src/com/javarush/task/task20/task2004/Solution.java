...
public class Solution {
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            PrintWriter outToFile = new PrintWriter(outputStream);
            outToFile.println(staticString);
            outToFile.println(i);
            outToFile.println(j);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            staticString = fromFile.readLine();
            i = Integer.parseInt(fromFile.readLine());
            j = Integer.parseInt(fromFile.readLine());
        }
